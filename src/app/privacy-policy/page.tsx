...
<p className="title">{`Privacy Policy for QR Make`}</p>
</div>
</div>
...
<li>
<p>{`<strong>Application</strong> refers to QR Make, the software program provided by the Company.`}</p>
</li>
<li>
<p>{`<strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to QR Make.`}</p>
</li>
<li>
...
<ul>
<li>By email: zozvia03@gmail.com</li>
</ul>
</div>
</div>
</div>
